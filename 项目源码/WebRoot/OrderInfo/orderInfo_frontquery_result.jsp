...
<jsp:include page="../header.jsp"></jsp:include>
				    		...
				    		<div class="row">
				    			<div class="col-md-12 top5">
				    				...
				    				<table class="table table-condensed table-hover">
				    					<tr class="success bold"><td>序号</td><td>订单id</td><td>下单用户</td><td>购买商品</td><td>购买数量</td><td>订单总价</td><td>订单状态</td><td>下单时间</td><td>收货人</td><td>收货人电话</td><td>操作</td></tr>
				    					<% 
				    						/*计算起始序号*/
 										...
 										<tr>
 											...
 											<td><%=orderInfo.getProductObj().getProductName() %></td>
	...
	<div class="col-md-3 wow fadeInRight">
		...
		<form name="orderInfoQueryForm" id="orderInfoQueryForm" action="<%=basePath %>OrderInfo/frontlist" class="mar_t15" method="post">
            ...
            <div class="form-group">
            	<label for="productObj_productId">购买商品：</label>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body" style="height:450px; overflow: scroll;">
		  ...
		  <div class="form-group">
		  	 <label for="orderInfo_orderCount_edit" class="col-md-3 text-right">购买数量:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="orderInfo_orderCount_edit" name="orderInfo.orderCount" class="form-control" placeholder="请输入购买数量">
			 </div>
		  </div>
		  <div class="form-group">
		  	 <label for="orderInfo_totalMoney_edit" class="col-md-3 text-right">订单总价:</label>
		  	 <div class="col-md-9">
			    <input type="text" id="orderInfo_totalMoney_edit" name="orderInfo.totalMoney" class="form-control" placeholder="请输入订单总价">
			 </div>
		  </div>
		  <div class="form-group">
