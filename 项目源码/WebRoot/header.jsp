...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">车展网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <li><a href="<%=basePath %>OrderInfo/frontlist">订单查询</a></li>
                <li><a href="<%=basePath %>Leaveword/frontlist">网站留言</a></li>-->
                <li><a href="<%=basePath %>NewsInfo/frontlist?infoTypeObj.typeId=1">性能展示</a></li>
                <li><a href="<%=basePath %>NewsInfo/frontlist?infoTypeObj.typeId=2">销售策略</a></li>
                <li><a href="<%=basePath %>NewsInfo/frontlist?infoTypeObj.typeId=3">能源介绍</a></li>
                <li><a href="<%=basePath %>NewsInfo/frontlist?infoTypeObj.typeId=4">汽车理赔</a></li>
                <li><a href="<%=basePath %>NewsInfo/frontlist?infoTypeObj.typeId=5">汽车保养</a></li>  
                <li><a href="<%=basePath %>NewsInfo/frontlist?infoTypeObj.typeId=6">购车政策</a></li>
                <li><a href="<%=basePath %>NewsInfo/frontlist?infoTypeObj.typeId=7">汽车文化</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>OrderInfo/userFrontlist"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;我的订单查询</a></li>
